(function (window) {
    ...
    c3_chart_internal_fn.load = function (targets, args) {
        ...
        if (targets) {
            ...
            // set type if args.typesDescriptor || args.type specified
            if (args.type || args.typesDescriptor) {
                targets.forEach(function (t) {
                    var type = args.typesDescriptor && args.typesDescriptor[t.id] ? args.typesDescriptor[t.id] : args.type;
